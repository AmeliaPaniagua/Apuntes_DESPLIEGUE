...
(base de datos distribuida: la información de los dominios con las IPs están distribuidas en muchos sitios)
- En los inicios de internet la información estaba centralizada.
  - Para ello se utilizaba un archivo **HOSTS**.
...
Los dominios de primer nivel, también se llaman niveles de nivel superior 
